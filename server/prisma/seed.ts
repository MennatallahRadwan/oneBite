...
const categories = [
  ...
  },
  {
    ...
    nameEn: 'Petit Four',
    nameAr: 'بتيفور',
    descriptionEn: 'Classic butter petit four in plain, sugar and filled styles',
...
const products: SeedProduct[] = [
  ...
  },
  {
    ...
    nameEn: 'Petit Four Regular Box',
    nameAr: 'علبة بتيفور متوسطة',
    descriptionEn: 'A delicious selection of fresh petit four in a convenient regular-size box.',
  ...
  },
  {
    ...
    nameEn: 'Gift Box',
    nameAr: 'علبة الهدايا',
    descriptionEn: 'An elegant box filled with a delicious assortment of petit four, perfect for gifting.',
  ...
  },
  {
    ...
    category: 'butter-cookies',
    nameEn: 'Petit Four Large Box',
    nameAr: 'علبة بتيفور كبيرة',
    descriptionEn: 'A generous selection of fresh petit four, perfect for sharing with family and friends.',
  ...
  },
  {
    ...
    category: 'butter-cookies',
    nameEn: 'Vanilla Petit Four',
    nameAr: 'بتيفور بالفانيلا',
    descriptionEn: 'Light, buttery vanilla petit four with a soft, delicate flavor.',
  ...
  },
  {
    ...
    category: 'butter-cookies',
    nameEn: 'Chocolate Petit Four',
    nameAr: 'بتيفور بالشوكولاتة',
    descriptionEn: 'Rich chocolate petit four with a soft texture and deep cocoa flavor.',
  ...
  },
  {
    slug: 'filled-cookies',
    category: 'butter-cookies',
    nameEn: 'Filled Petit Four',
    nameAr: 'بتيفور محشو',
    descriptionEn: 'Buttery petit four filled with smooth, sweet centers in a mixed assortment.',
